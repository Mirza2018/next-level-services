...
const HappyCustommer = () => {
    ...
    <div className="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 mt-10 text-center lg:mt-24 sm:gap-x-8 md:grid-cols-3">
            ...
            <div>
                <h3 className="font-bold text-7xl">
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-600 to-blue-600"> 48210 </span>
                </h3>
                <p className="mt-4 text-xl font-medium text-gray-900">Services delivered</p>
